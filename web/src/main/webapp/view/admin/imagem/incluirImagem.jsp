...
<div id="formsContent">
	<form:form method="POST" modelAttribute="imagem" onsubmit="return validarRequiredByName(['nome','endereco','enderecoMiniatura'])"
		action="${pageContext.request.contextPath}/admin/imagem/incluir">
		<ul id="messages"></ul>
		<fieldset>
