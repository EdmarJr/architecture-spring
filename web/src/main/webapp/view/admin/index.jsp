...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href='<c:url value="/resources/admin/font-awesome/css/font-awesome.min.css"/>'>
    <!-- Page Specific CSS -->
    <link rel="stylesheet" href='<c:url value="/resources/admin/css/morris-0.4.3.min.css"/>'>
  </head>
