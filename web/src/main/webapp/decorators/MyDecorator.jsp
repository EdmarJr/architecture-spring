...
<script>
	$(document).ready(
			function() {
				$('#liDefault', $('#navbarPrincipal')).attr(
						"class", "active");
				$('li', $('#navbarPrincipal')).each(
						function() {
							var href = $('a', $(this)).attr("href");
							var posicao = href.lastIndexOf("/") + 1;
							var jaFoi = true;
							if (window.location.href.indexOf(href.substring(
									posicao,href.length)) != -1) {
								$('#liDefault', $('#navbarPrincipal')).attr(
										"class", "");
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="row centered">
							...
							<p>
								${configuracaoEndereco.texto2}<br />${configuracaoEndereco.texto3}<br />
								${configuracaoEndereco.texto4}<br />
